...
<details>
<summary><b>[134] Manrope[wght].ttf</b></summary>
<details>
...
* ℹ **INFO** Could not detect which version of ttfautohint was used in this font. It is typically specified as a comment in the font version entries of the 'name' table. Such font version strings are currently: ['Version 4.001'] [code: version-not-detected]
...
* ℹ **INFO** Version string is: "Version 4.001"
...
* ℹ **INFO** This font contains the following optional tables [gasp, loca, DSIG, prep, GSUB, GPOS]
...
* 🍞 **PASS** Manrope[wght].ttf is named canonically.
...
* 🍞 **PASS** Name Table entry: Copyright field 'Copyright 2019 The Manrope Project Authors (https://github.com/sharanda/manrope)' matches canonical pattern.
